        ...
        <form method="post" action="suggest.php">
            <table>
                <tr>
                    ...
                    <td><input type="text" id="name_id" name="name" 
                ...
                <tr>
                    ...
                    <td><input type="text" id="email_id" name="email" 
                ...
                <tr>
                    ...
                    <td><select id="category_id" name="category">
                            ...
                            <option value="Books"
                                    <?php if(isset($category) && $category == "Books"){
                                            echo " selected";
                                            } ?>>
                                    Book</option>
                            <option value="Movies"
                                <?php if(isset($category) && $category == "Movies"){
                                            echo " selected";
                                            } ?>>
                                Movie</option>
                            <option value="Music"
                                <?php if(isset($category) && $category == "Music"){
                                            echo " selected";
                                            } ?>>
                                Music</option>
                        </select>
                ...
                <tr>
                    ...
                    <td><input type="text" id="title_id" name="title" 
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" id="year_id" name="year" 
                ...
                <tr>
                    ...
                    <td><textarea name="details" id="details_id"><?php if(isset($details)){
                                echo $details;
                                }?></textarea>
                    </td>
                </tr>
